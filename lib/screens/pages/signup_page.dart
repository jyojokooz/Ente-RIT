...
class _SignupPageState extends State<SignupPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _buttonSlide = createSlide(0.3, 0.8);
    _buttonFade = createFade(0.3, 0.7);
    _dividerSlide = createSlide(0.4, 0.9);
    _dividerFade = createFade(0.4, 0.8);
    _googleSlide = createSlide(0.5, 0.95);
    _googleFade = createFade(0.5, 0.9);
