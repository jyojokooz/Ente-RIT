...
class Step3PostDetails extends StatelessWidget {
  ...
  // --- UPDATED: Smooth Tagging Sheet Call ---
...
// ============================================================================
// UPDATED COMPONENT: Lag-free & Dual-Search User Tagging Sheet
// ============================================================================
...
class _UserTaggingSheetState extends State<UserTaggingSheet> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      ...
      // Run both queries simultaneously and merge results (to mimic an 'OR' query)
                ...
                _isLoading
                    ...
                    : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          onTap: () {
                            // Ensure focus stays on input or hide keyboard naturally
                            _toggleSelection(username);
                          },
