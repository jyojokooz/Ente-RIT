...
import '../screens/ai_chat_screen.dart'; // AiChatMessage model is in this file
...
class ChatAiService {
  ...
  Future<DocumentReference> addMessage(
      String userId, String conversationId, AiChatMessage message) async {
  ...
  Future<void> updateMessageContent(String userId, String conversationId,
  ...
  Future<String> createConversation(
      String userId, AiChatMessage firstUserMessage) async {
