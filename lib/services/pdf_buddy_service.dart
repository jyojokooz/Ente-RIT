...
class PdfBuddyService {
  ...
  // Ensure your .env file has a line: GEMINI_API_KEY=YOUR_API_KEY
  final String? apiKey = dotenv.env['GEMINI_API_KEY'];

  /// Extracts all readable text from a given PDF file.
  ///
  /// Takes a [File] object pointing to a PDF.
  /// Returns a [String] containing the concatenated text from all pages.
  ...
  ///
  /// Takes the extracted [String] text from the PDF.
  /// Returns a summarized [String] generated by the AI.
  /// Throws an [Exception] if the API key is missing or the API call fails.
  Future<String> summarizeText(String text) async {
    ...
    // 2. Truncate the text to a safe limit to prevent exceeding API token limits.
    // gemini-1.5-flash has a very large context window (1M tokens), but this is a good safety measure.
